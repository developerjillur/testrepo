...
class ListItemThums extends React.Component {
  ...
  render() {
    ...
    return (
      <ImageGallery items={images} lazyLoad={true} infinite={false} showNav={false} showBullets={false} showFullscreenButton={true}  useBrowserFullscreen={false} showPlayButton={false} slideOnThumbnailOver={true} showIndex={false} />
    );
  }

}
export default ListItemThums;