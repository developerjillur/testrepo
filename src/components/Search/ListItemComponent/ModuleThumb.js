...
class ModuleThumb extends React.Component {
  ...
  render() {
    ...
    return (
      <ImageGallery items={images} lazyLoad={true} infinite={false} showNav={false} showBullets={false} showFullscreenButton={true} useBrowserFullscreen={false} showPlayButton={true} slideOnThumbnailOver={false} showIndex={true} />
    );
  }
