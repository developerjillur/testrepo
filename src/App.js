    ...
    return(
        <Router>
           <Switch>
             ...
             <ScrollToTopRoute exact={true} path={'/Search'} component={SearchPage} />
             <ScrollToTopRoute exact={true} path={'/Digital-marketing'} component={DigitalMarketing} />
             ...
             <ScrollToTopRoute path="/Pages/Whowe" component={WhoWeAre} />
           </Switch>
        </Router>
    );
  }
